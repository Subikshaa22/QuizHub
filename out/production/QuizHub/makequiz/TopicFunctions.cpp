...
extern "C" {
    ...
    JNIEXPORT jstring JNICALL Java_MakeQuiz_convertToLowerCase(JNIEnv *env, jobject obj, jstring input)
    {
    ...
    JNIEXPORT jint JNICALL Java_MakeQuiz_displayTopics(JNIEnv *env, jobject obj) 
    {
    ...
    JNIEXPORT jboolean JNICALL Java_MakeQuiz_CheckIfTopicExists(JNIEnv *env, jobject obj, jstring topic) 
    {
        bool exists = false;
        string line;
        ...
        while(getline(infile, line)) {
            ...
            jstring low_file_topic = Java_MakeQuiz_convertToLowerCase(env, obj, env->NewStringUTF(file_topic.c_str()));
            jstring low_topic = Java_MakeQuiz_convertToLowerCase(env, obj, topic);
    ...
    JNIEXPORT jint JNICALL Java_MakeQuiz_SaveTopic(JNIEnv *env, jobject obj, jstring topic) 
    {
